...
#include "../../MusicPlayer/picturebutton.h"
...
void pictureButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pictureButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (pictureButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pictureButton::entered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (pictureButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pictureButton::entered)) {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject pictureButton::staticMetaObject = { {
    &QAbstractButton::staticMetaObject,
    qt_meta_stringdata_pictureButton.data,
    qt_meta_data_pictureButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
