...
void NewCourier::setInitData()
{
    ...
    nitem->setPicture(":/NewMusic/image/NewMusic/01.png");
    ...
    item2->setSizeHint(QSize(item->sizeHint().width(), 80));
    NewCourierItem * nitem2 = new NewCourierItem();
    nitem2->setNum(02); //设置编号
    nitem2->setPicture(":/NewMusic/image/NewMusic/02.png");
    ...
    item3->setSizeHint(QSize(item->sizeHint().width(), 80));
    NewCourierItem * nitem3 = new NewCourierItem();
    nitem3->setNum(03); //设置编号
    nitem3->setPicture(":/NewMusic/image/NewMusic/03.png");
    ...
    item4->setSizeHint(QSize(item->sizeHint().width(), 80));
    NewCourierItem * nitem4 = new NewCourierItem();
    nitem4->setNum(04); //设置编号
    nitem4->setPicture(":/NewMusic/image/NewMusic/04.png");
    ...
    item5->setSizeHint(QSize(item->sizeHint().width(), 80));
    NewCourierItem * nitem5 = new NewCourierItem();
    nitem5->setNum(05); //设置编号
    nitem5->setPicture(":/NewMusic/image/NewMusic/05.png");
...
void NewCourier::setChinese()
{
    ...
    NewCourierItem * nitem = new NewCourierItem();
    nitem->setNum(01); //设置编号
    nitem->setPicture(":/NewMusic/image/NewMusic/06.png");
    ...
    NewCourierItem * nitem2 = new NewCourierItem();
    nitem2->setNum(02); //设置编号
    nitem2->setPicture(":/NewMusic/image/NewMusic/01.png");
...
void NewCourier::setEurope()
{
    ...
    NewCourierItem * nitem = new NewCourierItem();
    nitem->setNum(01); //设置编号
    nitem->setPicture(":/NewMusic/image/NewMusic/07.png");
    ...
    NewCourierItem * nitem2 = new NewCourierItem();
    nitem2->setNum(02); //设置编号
    nitem2->setPicture(":/NewMusic/image/NewMusic/08.png");
    ...
    NewCourierItem * nitem3 = new NewCourierItem();
    nitem3->setNum(03); //设置编号
    nitem3->setPicture(":/NewMusic/image/NewMusic/09.png");
    ...
    NewCourierItem * nitem4 = new NewCourierItem();
    nitem4->setNum(04); //设置编号
    nitem4->setPicture(":/NewMusic/image/NewMusic/10.png");
    ...
    NewCourierItem * nitem5 = new NewCourierItem();
    nitem5->setNum(05); //设置编号
    nitem5->setPicture(":/NewMusic/image/NewMusic/11.png");
...
void NewCourier::setKorea()
{
    ...
    NewCourierItem * nitem = new NewCourierItem();
    nitem->setNum(01); //设置编号
    nitem->setPicture(":/NewMusic/image/NewMusic/12.png");
    ...
    NewCourierItem * nitem2 = new NewCourierItem();
    nitem2->setNum(02); //设置编号
    nitem2->setPicture(":/NewMusic/image/NewMusic/13.png");
    ...
    NewCourierItem * nitem3 = new NewCourierItem();
    nitem3->setNum(03); //设置编号
    nitem3->setPicture(":/NewMusic/image/NewMusic/14.png");
    ...
    NewCourierItem * nitem4 = new NewCourierItem();
    nitem4->setNum(04); //设置编号
    nitem4->setPicture(":/NewMusic/image/NewMusic/15.png");
    ...
    NewCourierItem * nitem5 = new NewCourierItem();
    nitem5->setNum(05); //设置编号
    nitem5->setPicture(":/NewMusic/image/NewMusic/16.png");
...
void NewCourier::setJapan()
{
    ...
    NewCourierItem * nitem = new NewCourierItem();
    nitem->setNum(01); //设置编号
    nitem->setPicture(":/NewMusic/image/NewMusic/17.png");
    ...
    NewCourierItem * nitem2 = new NewCourierItem();
    nitem2->setNum(02); //设置编号
    nitem2->setPicture(":/NewMusic/image/NewMusic/18.png");
    ...
    NewCourierItem * nitem3 = new NewCourierItem();
    nitem3->setNum(03); //设置编号
    nitem3->setPicture(":/NewMusic/image/NewMusic/19.png");
    ...
    NewCourierItem * nitem4 = new NewCourierItem();
    nitem4->setNum(04); //设置编号
    nitem4->setPicture(":/NewMusic/image/NewMusic/20.png");
    ...
    NewCourierItem * nitem5 = new NewCourierItem();
    nitem5->setNum(05); //设置编号
    nitem5->setPicture(":/NewMusic/image/NewMusic/21.png");
