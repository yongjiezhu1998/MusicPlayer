...
void PictureWidget::setButtonGroup()
{
    ...
    m_BtnGroup->addButton(ui->btnPic0_2,0);
    m_BtnGroup->addButton(ui->btnPic1_2,1);
    m_BtnGroup->addButton(ui->btnPic2_2,2);
    m_BtnGroup->addButton(ui->btnPic3_2,3);
    m_BtnGroup->addButton(ui->btnPic4_2,4);
    m_BtnGroup->addButton(ui->btnPic5_2,5);
    m_BtnGroup->addButton(ui->btnPic6_2,6);
    m_BtnGroup->addButton(ui->btnPic7_2,7);
    m_BtnGroup->addButton(ui->btnPic8_2,8);
    m_BtnGroup->addButton(ui->btnPic9_2,9);
...
{
    //设置样式 无标边框
    ui->graphicsView_2->setStyleSheet("background: transparent; padding: 0px; border: 0px;");
    ...
    //添加对应图片 :/picturewall/image/picturewall/%1.png
    for (int i = 1; i<=10;i++) {
        m_PixmapList.append(QPixmap(QString(":/picturewall/image/picturewall/%1.png").arg(i)));
    }
    for (int i = 0; i<10;i++) {
